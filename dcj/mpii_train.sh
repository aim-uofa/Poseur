...
PORT=29503 CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/mobilenetv2_mpii_256x256.py 4 --work-dir work_dirs/mobilenetv2_mpii_256x256 --cfg-options data.train_dataloader.samples_per_gpu=16 data.workers_per_gpu=0
