# https://github.com/open-mmlab/mmpose/blob/master/configs/body/3d_kpt_sview_rgb_img/pose_lift/h36m/simplebaseline3d_h36m.py
...
data = dict(
    ...
    train=dict(
        type='CustomBody3DH36MDataset',
        e2e=True,
        ann_file=f'{data_root}/annotation_body3d/fps50/h36m_mosh_train.npz',
    ...
    val=dict(
        type='CustomBody3DH36MDataset',
        ann_file=f'{data_root}/annotation_body3d/fps50/h36m_valid_protocol2.npz',
        img_prefix=f'{data_root}/images/',
        data_cfg=data_cfg,
